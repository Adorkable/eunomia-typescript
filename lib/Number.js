...
const orderedMinMaxWrapper = (perform) => {
    return (number, minimum, maximum) => {
        const [useMinimum, useMaximum] = (0, exports.orderMinMax)(minimum, maximum);
 ...
 */
exports.clamp = (0, exports.orderedMinMaxWrapper)((number, minimum, maximum) => {
    let result = number;
    if (result < minimum) {
        result = minimum;
    }
...
exports.mirror = (0, exports.orderedMinMaxWrapper)((number, minimum, maximum) => {
    let result = number;
...
exports.wrap = (0, exports.orderedMinMaxWrapper)((number, minimum, maximum) => {
    let result = number;
    while (result < minimum || result > maximum) {
        if (result < minimum) {
            const difference = minimum - result;
