...
const colorTypeWithAlphaToHexString = (color, alpha) => {
    const hexStringWithHash = (0, exports.colorTypeToHexString)(color);
...
const colorGradientToCSS = (colorGradient) => {
    ...
    const colorStops = colorGradient.colorStops.map((colorStop) => {
        return `${(0, exports.colorTypeToHexString)(colorStop.color)} ${(colorStop.location * 100).toString(10)}%`;
    });
...
const randomColor = (randomFunction) => {
    ...
    return (0, exports.colorHexStringToColorType)(hexString);
};
