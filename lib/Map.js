...
const mapMap = (items, mapTo) => {
    const result = {};
    (0, exports.mapForEach)(items, (value, key) => {
...
const mergeMaps = (itemsArray) => {
    return itemsArray.reduce((merged, currents) => {
        (0, exports.mapForEach)(currents, (value, id) => {
            merged[id] = value;
        });
        return merged;
    }, {});
...
const mapsEqual = (leftItems, rightItems, isEqual) => {
    let result = true;
    const ids = (0, lodash_union_1.default)(Object.keys(leftItems), Object.keys(rightItems));
